...
program+="array3=['test','Hallo','test'];";
program+="if (removeFromArray(array3,'test')==true) print('PASSED'); else print('FAILED');\n";
program+="if (removeFromArray(array3,'test')==true) print('PASSED'); else print('FAILED');\n";
program+="if (removeFromArray(array3,'test')==false) print('PASSED'); else print('FAILED');\n";
